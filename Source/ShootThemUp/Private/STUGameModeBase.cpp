...
FLinearColor ASTUGameModeBase::DetermineColorByTeamID(int32 TeamID) const
{
    ...
    UE_LOG(
        LogSTUGameModeBase, Warning, TEXT("No color for team id: %i, set to deffault: %s"), TeamID, *GameData.DefaultTeamColor.ToString());
...
{
    UE_LOG(LogSTUGameModeBase, Display, TEXT("====== GAME OVET ======"));
    LogPlayerInfo();
